              ...
              {guidelinesOpen && (
                <div className="mt-3 space-y-4 text-sm text-[#111111]">
                  <div>
                    ...
                    <p className="text-[#444444] leading-relaxed">Only officially designated NIT Hamirpur centre heads with a valid institute email (<span className="font-semibold">@nith.ac.in</span>) are eligible.</p>
                  </div>
                  <div>
