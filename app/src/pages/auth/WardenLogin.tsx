      ...
      <div className="container mx-auto px-4 py-12 flex justify-center">
        <div className="bg-white w-full shadow-sm border border-gray-100 rounded-md overflow-hidden max-w-[450px]">
          <div className="bg-nith-primary text-white py-4 px-5">
            <h2 className="text-lg font-bold mb-1">Warden Login</h2>
            <p className="text-sm text-white/70 mb-0">Access your hostel complaint dashboard.</p>
          </div>
          ...
          <div className="p-6">
            <form>
              ...
              <p className="text-center text-sm text-gray-500 mt-4 mb-0">
                Don't have an account? <Link to="/signup/warden" className="text-nith-primary-light font-semibold no-underline hover:underline">Register here</Link>
              </p>
            </form>
          </div>
        </div>
