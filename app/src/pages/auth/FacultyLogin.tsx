      ...
      <div className="container py-5 d-flex justify-content-center">
        <div className="card w-100 shadow-sm border-0" style={{ maxWidth: '450px' }}>
          <div className="card-header bg-nith-primary text-white py-3">
            <h2 className="fs-5 fw-bold mb-1">Faculty Login</h2>
            <p className="small text-white-50 mb-0">Access your complaint dashboard.</p>
          </div>
            ...
            <form>
              <div className="mb-4">
                <div className="mb-3">
                  ...
                  <input type="email" className="form-control" placeholder="faculty@nith.ac.in" required />
                </div>
              ...
              <p className="text-center small text-secondary mt-3 mb-0">
                Don't have an account? <Link to="/signup/faculty" className="text-nith-primary-light fw-semibold text-decoration-none">Register here</Link>
              </p>
            </form>
          </div>
        </div>
