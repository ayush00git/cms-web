      ...
      <div className="flex-grow flex flex-col">
        ...
        <div className="border-b border-[#E5E5E5] py-5">
          <div className="max-w-6xl mx-auto w-full px-8">
            <h1 className="text-xl font-bold text-[#111111]">Centre Head Login</h1>
            <p className="text-sm text-[#666666] mt-0.5">Access your centre complaint dashboard.</p>
          </div>
        </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <Link to="/centre-head/forgot-password" className="text-xs font-medium text-[#666666] hover:text-[#111111] transition-colors cursor-pointer">
                      Forgot Password?
                    </Link>
                  </div>
