      ...
      <div className="flex-grow flex flex-col">
        ...
        <div className="flex flex-grow divide-x divide-[#E5E5E5] max-w-6xl mx-auto w-full">
          ...
          <form onSubmit={handleSubmit} className="flex-1 px-8 py-8 space-y-6 min-w-0">
            ...
            <div>
              <h2 className="text-xs font-bold uppercase tracking-widest text-[#666666] mb-4">Hostel Assignment</h2>
              <div className="max-w-sm">
                <label className={labelCls}>Assigned Hostel</label>
                <select
                  name="hostel"
          ...
          <aside className="w-72 shrink-0 px-6 py-8 space-y-6 bg-white">
            ...
            <div>
              ...
              <p className="text-sm text-[#111111] leading-relaxed">
                Only officially assigned NIT Hamirpur wardens with a valid institute email (<span className="font-semibold">@nith.ac.in</span>) are eligible to register.
              </p>
            </div>
            ...
            <div>
              <h3 className="text-xs font-bold uppercase tracking-widest text-[#666666] mb-3">Hostel Complaints</h3>
              <p className="text-sm text-[#111111] leading-relaxed">
                Wardens are the only role authorised to file complaints for hostel common areas such as corridors, washrooms, and common rooms.
              </p>
            </div>
