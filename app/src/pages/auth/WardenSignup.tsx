      ...
      <div className="container mx-auto px-4 py-12 flex justify-center">
        <div className="bg-white w-full shadow-sm border border-gray-100 rounded-md overflow-hidden max-w-[550px]">
          <div className="bg-nith-primary text-white py-4 px-5">
            <h2 className="text-lg font-bold mb-1">Warden Registration</h2>
            <p className="text-sm text-white/70 mb-0">Register to manage complaints for your Hostel.</p>
          </div>
            ...
            <form>
              <div className="mb-6">
                ...
                <div className="mb-4">
                  ...
                  <input type="email" className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-nith-primary focus:ring-1 focus:ring-nith-primary" placeholder="warden@nith.ac.in" required />
                </div>
                ...
                <div className="mb-4">
                  <label className="block font-semibold text-gray-800 text-sm mb-1.5">Assigned Hostel</label>
              ...
              <p className="text-center text-sm text-gray-500 mt-4 mb-0">
                Already registered? <Link to="/login/warden" className="text-nith-primary-light font-semibold no-underline hover:underline">Login here</Link>
              </p>
            </form>
          </div>
        </div>
