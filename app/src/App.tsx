      ...
      <header className="bg-white py-4 shadow-sm relative z-20">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-4 mb-4 md:mb-0">
            <img 
              src="https://upload.wikimedia.org/wikipedia/en/9/91/National_Institute_of_Technology%2C_Hamirpur_Logo.png" 
              alt="NITH Logo" 
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="text-sm space-y-2">
              <li><a href="#" className="hover:text-white transition-colors">NIRF</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Tenders</a></li>
          ...
          <div>
            <h3 className="text-white font-bold text-lg mb-4">Student Corner</h3>
            <ul className="text-sm space-y-2">
